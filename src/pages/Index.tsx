...
import { Layers, Search, FlipHorizontal, Brain, Bookmark } from "lucide-react";
...
const features = [
  ...
  { to: "/search", icon: Search, label: "Search", desc: "Find by name instantly", color: "bg-terracotta-light text-accent" },
  { to: "/flashcards", icon: FlipHorizontal, label: "Flashcards", desc: "Learn by flipping cards", color: "bg-sage-light text-primary" },
  { to: "/quiz", icon: Brain, label: "Quiz", desc: "Test your knowledge", color: "bg-terracotta-light text-accent" },
];
